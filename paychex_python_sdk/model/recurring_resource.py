    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class calculationType(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "FLAT_DOLLAR_AMOUNT:This is used for a specific dollar amount": "FLAT_DOLLAR_AMOUNTTHIS_IS_USED_FOR_A_SPECIFIC_DOLLAR_AMOUNT",
                        "PERCENTAGE:This is used for when a Percentage will be used to calculate the amount and will need a calculationBaseId to specify what to apply against": "PERCENTAGETHIS_IS_USED_FOR_WHEN_A_PERCENTAGE_WILL_BE_USED_TO_CALCULATE_THE_AMOUNT_AND_WILL_NEED_A_CALCULATION_BASE_ID_TO_SPECIFY_WHAT_TO_APPLY_AGAINST",
                        "RATE_X_UNITS:This is used for apply the rate against units and will need a calculationBaseId to specify what to apply against": "RATE_X_UNITSTHIS_IS_USED_FOR_APPLY_THE_RATE_AGAINST_UNITS_AND_WILL_NEED_A_CALCULATION_BASE_ID_TO_SPECIFY_WHAT_TO_APPLY_AGAINST",
                        "RATE_X_HOURS:This is used for apply the rate against hours and will need a calculationBaseId to specify what to apply against.": "RATE_X_HOURSTHIS_IS_USED_FOR_APPLY_THE_RATE_AGAINST_HOURS_AND_WILL_NEED_A_CALCULATION_BASE_ID_TO_SPECIFY_WHAT_TO_APPLY_AGAINST_",
                    }
