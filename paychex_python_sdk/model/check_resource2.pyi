...
class CheckResource2(
        ...
        class properties:
            ...
            class earnings(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PayComponentResource2']:
                        return PayComponentResource2
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PayComponentResource2'], typing.List['PayComponentResource2']],
                ...
                def __getitem__(self, i: int) -> 'PayComponentResource2':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workerId", "paycheckId", "payPeriodId", "checkCorrelationId", "blockAutoDistribution", "earnings", "deductions", "informational", "links", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workerId", "paycheckId", "payPeriodId", "checkCorrelationId", "blockAutoDistribution", "earnings", "deductions", "informational", "links", ], str]):
