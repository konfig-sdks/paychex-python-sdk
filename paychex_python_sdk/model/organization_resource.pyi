...
class OrganizationResource(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["organizationId", "name", "number", "level", "links", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["organizationId", "name", "number", "level", "links", ], str]):
