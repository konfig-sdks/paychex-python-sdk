...
class ClientName(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def clients() -> typing.Type['Client']:
                return Client
            
            
            class clientNameVersions(
                schemas.ListSchema
            ):
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ClientNameVersion']:
                        return ClientNameVersion
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ClientNameVersion'], typing.List['ClientNameVersion']],
                ...
                def __getitem__(self, i: int) -> 'ClientNameVersion':
            ...
            __annotations__ = {
                ...
                "clients": clients,
                "clientNameVersions": clientNameVersions,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["clients"]) -> 'Client': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["clientNameVersions"]) -> MetaOapg.properties.clientNameVersions: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "type", "createdDate", "createdByApplicationName", "createdByUserId", "createdByApplicationSubProcessName", "clients", "clientNameVersions", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["clients"]) -> typing.Union['Client', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["clientNameVersions"]) -> typing.Union[MetaOapg.properties.clientNameVersions, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "type", "createdDate", "createdByApplicationName", "createdByUserId", "createdByApplicationSubProcessName", "clients", "clientNameVersions", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        clients: typing.Union['Client', schemas.Unset] = schemas.unset,
        clientNameVersions: typing.Union[MetaOapg.properties.clientNameVersions, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
