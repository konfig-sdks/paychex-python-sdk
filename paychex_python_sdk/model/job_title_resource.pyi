...
class JobTitleResource(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "jobTitleId", "startDate", "endDate", "links", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "jobTitleId", "startDate", "endDate", "links", ], str]):
