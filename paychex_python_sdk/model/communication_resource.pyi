...
class CommunicationResource(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["communicationId", "type", "usageType", "dialCountry", "dialArea", "dialNumber", "dialExtension", "uri", "streetLineOne", "streetLineTwo", "postOfficeBox", "city", "postalCode", "postalCodeExtension", "countrySubdivisionCode", "countryCode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["communicationId", "type", "usageType", "dialCountry", "dialArea", "dialNumber", "dialExtension", "uri", "streetLineOne", "streetLineTwo", "postOfficeBox", "city", "postalCode", "postalCodeExtension", "countrySubdivisionCode", "countryCode", ], str]):
