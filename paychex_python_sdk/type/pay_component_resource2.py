...
class RequiredPayComponentResource2(TypedDict):
    pass

class OptionalPayComponentResource2(TypedDict, total=False):
    # Description
    description: str
    ...
    appliesToWorkerTypes: PayComponentResource2AppliesToWorkerTypes
...
class PayComponentResource2(RequiredPayComponentResource2, OptionalPayComponentResource2):
    pass
