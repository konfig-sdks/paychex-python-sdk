...
class RequiredCommunicationResource1(TypedDict):
    pass

class OptionalCommunicationResource1(TypedDict, total=False):
...
class CommunicationResource1(RequiredCommunicationResource1, OptionalCommunicationResource1):
    pass
