...
from paychex_python_sdk.pydantic.pay_component_resource import PayComponentResource
...
class CheckResource(BaseModel):
    ...
    block_auto_distribution: typing.Optional[bool] = Field(None, alias='blockAutoDistribution')
    ...
    earnings: typing.Optional[typing.List[PayComponentResource]] = Field(None, alias='earnings')

    # Deduction pay components on the check.
    deductions: typing.Optional[typing.List[PayComponentResource]] = Field(None, alias='deductions')

    # The check date 
    check_date: typing.Optional[str] = Field(None, alias='checkDate')

    # Informational pay components on the check.
    informational: typing.Optional[typing.List[PayComponentResource]] = Field(None, alias='informational')

    # Tax pay components on the check.
    taxes: typing.Optional[typing.List[PayComponentResource]] = Field(None, alias='taxes')
