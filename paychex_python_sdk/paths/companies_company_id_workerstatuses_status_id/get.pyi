...
WorkerStatusIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'companyId': typing.Union[CompanyIdSchema, str, ],
        'workerStatusId': typing.Union[WorkerStatusIdSchema, str, ],
    }
)
...
request_path_worker_status_id = api_client.PathParameter(
    name="workerStatusId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=WorkerStatusIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = WorkerStatusSchema
SchemaFor200ResponseBodyApplicationVndPaychexCompanyWorkerstatusV1json = WorkerStatusSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.workerstatus.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyWorkerstatusV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_status_mapped_args(
        self,
        company_id: str,
        worker_status_id: str,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        if company_id is not None:
            _path_params["companyId"] = company_id
        if worker_status_id is not None:
            _path_params["workerStatusId"] = worker_status_id
    ...
    async def _aget_status_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/workerstatuses/{statusId}',
            headers=_headers,
        )
