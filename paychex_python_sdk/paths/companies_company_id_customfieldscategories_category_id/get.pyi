...
SchemaFor200ResponseBodyApplicationVndPaychexCompanyCustomfieldscategoryV1json = CustomFieldsCategoryResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.customfieldscategory.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyCustomfieldscategoryV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_custom_fields_category_mapped_args(
        self,
        company_id: str,
        category_id: str,
    ...
    async def _aget_custom_fields_category_oapg(
        self,
    ...
    def _get_custom_fields_category_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCustomFieldsCategoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_custom_fields_category(
        self,
        company_id: str,
        category_id: str,
        **kwargs,
        ...
        args = self._get_custom_fields_category_mapped_args(
            company_id=company_id,
            category_id=category_id,
        )
        return await self._aget_custom_fields_category_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_custom_fields_category(
        self,
        company_id: str,
        category_id: str,
    ) -> typing.Union[
        ...
        return self._get_custom_fields_category_oapg(
            path_params=args.path,
        )

class GetCustomFieldsCategory(BaseApi):
    ...
    async def aget_custom_fields_category(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_custom_fields_category(
            company_id=company_id,
            category_id=category_id,
            **kwargs,
        )
    ...
    def get_custom_fields_category(
        ...
        raw_response = self.raw.get_custom_fields_category(
            company_id=company_id,
            category_id=category_id,
        )
        if validate:
