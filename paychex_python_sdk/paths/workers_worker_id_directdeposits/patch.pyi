...
# body param
SchemaForRequestBodyApplicationJson = DirectDepositResourceSchema
SchemaForRequestBodyApplicationVndPaychexPayrollDirectdepositsV1json = DirectDepositResourceSchema


request_body_direct_deposit_resource = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
        'application/vnd.paychex.payroll.directdeposits.v1+json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationVndPaychexPayrollDirectdepositsV1json),
    },
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = DirectDepositResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexPayrollDirectdepositsV1json = DirectDepositResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.payroll.directdeposits.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexPayrollDirectdepositsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _update_direct_deposits_mapped_args(
        self,
        worker_id: str,
        direct_deposit_id: typing.Optional[str] = None,
        ...
        if direct_deposit_id is not None:
            _body["directDepositId"] = direct_deposit_id
    ...
    async def _aupdate_direct_deposits_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{workerId}/directdeposits',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_direct_deposit_resource.serialize(body, content_type)
    ...
    def _update_direct_deposits_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateDirectDepositsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_direct_deposits(
        self,
        worker_id: str,
        direct_deposit_id: typing.Optional[str] = None,
        start_date: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._update_direct_deposits_mapped_args(
            worker_id=worker_id,
        ...
        return await self._aupdate_direct_deposits_oapg(
            body=args.body,
    ...
    def update_direct_deposits(
        ...
        return self._update_direct_deposits_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateDirectDeposits(BaseApi):
    ...
    async def aupdate_direct_deposits(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_direct_deposits(
            worker_id=worker_id,
            direct_deposit_id=direct_deposit_id,
            start_date=start_date,
            payment_type=payment_type,
    ...
    def update_direct_deposits(
        ...
        raw_response = self.raw.update_direct_deposits(
            worker_id=worker_id,
            direct_deposit_id=direct_deposit_id,
            start_date=start_date,
            payment_type=payment_type,
