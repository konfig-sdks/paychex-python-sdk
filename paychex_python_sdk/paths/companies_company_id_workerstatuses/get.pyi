...
from paychex_python_sdk.model.worker_status import WorkerStatus as WorkerStatusSchema
from paychex_python_sdk.model.error_resource import ErrorResource as ErrorResourceSchema

from paychex_python_sdk.type.worker_status import WorkerStatus
...
from paychex_python_sdk.pydantic.worker_status import WorkerStatus as WorkerStatusPydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkerStatusSchema
SchemaFor200ResponseBodyApplicationVndPaychexCompanyWorkerstatusesV1json = WorkerStatusSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.workerstatuses.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyWorkerstatusesV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _list_worker_statuses_mapped_args(
        self,
        company_id: str,
    ...
    async def _alist_worker_statuses_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/workerstatuses',
            headers=_headers,
        )
    ...
    def _list_worker_statuses_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListWorkerStatusesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_worker_statuses(
        self,
        company_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_worker_statuses_mapped_args(
            company_id=company_id,
        )
        return await self._alist_worker_statuses_oapg(
    ...
    def list_worker_statuses(
        ...
        return self._list_worker_statuses_oapg(
            path_params=args.path,
        )

class ListWorkerStatuses(BaseApi):
    ...
    async def alist_worker_statuses(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkerStatusPydantic:
        raw_response = await self.raw.alist_worker_statuses(
            company_id=company_id,
            **kwargs,
        )
        if validate:
            return WorkerStatusPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkerStatusPydantic, raw_response.body)
    ...
    def list_worker_statuses(
        ...
        raw_response = self.raw.list_worker_statuses(
            company_id=company_id,
        )
        if validate:
            return WorkerStatusPydantic(**raw_response.body)
