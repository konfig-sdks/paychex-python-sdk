...
SchemaFor200ResponseBodyApplicationJson = Status1Schema
SchemaFor200ResponseBodyApplicationVndPaychexCompanyWorkerstatusesV1json = Status1Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_worker_status_list_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aget_worker_status_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{workerId}/status',
            headers=_headers,
        )
    ...
    def _get_worker_status_list_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetWorkerStatusListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_worker_status_list(
        self,
        worker_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_worker_status_list_mapped_args(
            worker_id=worker_id,
        )
        return await self._aget_worker_status_list_oapg(
    ...
    def get_worker_status_list(
        ...
        return self._get_worker_status_list_oapg(
            path_params=args.path,
        )

class GetWorkerStatusList(BaseApi):
    ...
    async def aget_worker_status_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_worker_status_list(
            worker_id=worker_id,
            **kwargs,
        )
        if validate:
            return Status1Pydantic(**raw_response.body)
        return api_client.construct_model_instance(Status1Pydantic, raw_response.body)
    ...
    def get_worker_status_list(
        ...
        raw_response = self.raw.get_worker_status_list(
            worker_id=worker_id,
        )
        if validate:
            return Status1Pydantic(**raw_response.body)
