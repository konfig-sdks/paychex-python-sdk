...
SchemaFor200ResponseBodyApplicationVndPaychexWorkerContactV1json = WorkerContactResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.worker.contact.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexWorkerContactV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_contact_by_contact_id_mapped_args(
        self,
        worker_id: str,
        contact_id: str,
    ...
    async def _aget_contact_by_contact_id_oapg(
        self,
    ...
    def _get_contact_by_contact_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetContactByContactIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_contact_by_contact_id(
        self,
        worker_id: str,
        contact_id: str,
        **kwargs,
        ...
        args = self._get_contact_by_contact_id_mapped_args(
            worker_id=worker_id,
            contact_id=contact_id,
        )
        return await self._aget_contact_by_contact_id_oapg(
    ...
    def get_contact_by_contact_id(
        ...
        return self._get_contact_by_contact_id_oapg(
            path_params=args.path,
        )

class GetContactByContactId(BaseApi):
    ...
    async def aget_contact_by_contact_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_contact_by_contact_id(
            worker_id=worker_id,
            contact_id=contact_id,
            **kwargs,
        )
    ...
    def get_contact_by_contact_id(
        ...
        raw_response = self.raw.get_contact_by_contact_id(
            worker_id=worker_id,
            contact_id=contact_id,
        )
        if validate:
