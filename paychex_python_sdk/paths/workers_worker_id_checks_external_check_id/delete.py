...
class BaseApi(api_client.Api):
    ...
    def _remove_worker_check_mapped_args(
        self,
        worker_id: str,
        paycheck_id: str,
    ...
    async def _aremove_worker_check_oapg(
        self,
...
class RemoveWorkerCheckRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_worker_check(
        self,
        worker_id: str,
        paycheck_id: str,
        **kwargs,
        ...
        args = self._remove_worker_check_mapped_args(
            worker_id=worker_id,
            paycheck_id=paycheck_id,
        )
        return await self._aremove_worker_check_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_worker_check(
        self,
        worker_id: str,
        paycheck_id: str,
    ) -> typing.Union[
        ...
        return self._remove_worker_check_oapg(
            path_params=args.path,
        )

class RemoveWorkerCheck(BaseApi):
    ...
    async def aremove_worker_check(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_worker_check(
            worker_id=worker_id,
            paycheck_id=paycheck_id,
            **kwargs,
        )
    ...
    def remove_worker_check(
        ...
        raw_response = self.raw.remove_worker_check(
            worker_id=worker_id,
            paycheck_id=paycheck_id,
        )
        if validate:
