...
class BaseApi(api_client.Api):
    ...
    def _get_communications_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aget_communications_oapg(
        self,
...
class GetCommunicationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_communications(
        self,
        worker_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_communications_mapped_args(
            worker_id=worker_id,
        )
        return await self._aget_communications_oapg(
    ...
    def get_communications(
        ...
        return self._get_communications_oapg(
            path_params=args.path,
        )

class GetCommunications(BaseApi):
    ...
    async def aget_communications(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_communications(
            worker_id=worker_id,
            **kwargs,
        )
        if validate:
    ...
    def get_communications(
        ...
        raw_response = self.raw.get_communications(
            worker_id=worker_id,
        )
        if validate:
            return CommunicationResource1Pydantic(**raw_response.body)
