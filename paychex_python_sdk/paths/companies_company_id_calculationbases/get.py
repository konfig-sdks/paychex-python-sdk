...
from paychex_python_sdk.model.calculation_base import CalculationBase as CalculationBaseSchema
from paychex_python_sdk.model.error_resource import ErrorResource as ErrorResourceSchema

from paychex_python_sdk.type.calculation_base import CalculationBase
...
from paychex_python_sdk.pydantic.calculation_base import CalculationBase as CalculationBasePydantic
...
SchemaFor200ResponseBodyApplicationJson = CalculationBaseSchema
SchemaFor200ResponseBodyApplicationVndPaychexPayrollCalculationbasesV1json = CalculationBaseSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.payroll.calculationbases.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexPayrollCalculationbasesV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_calculation_bases_mapped_args(
        self,
        company_id: str,
    ...
    async def _aget_calculation_bases_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/calculationbases',
            headers=_headers,
        )
    ...
    def _get_calculation_bases_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCalculationBasesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_calculation_bases(
        self,
        company_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_calculation_bases_mapped_args(
            company_id=company_id,
        )
        return await self._aget_calculation_bases_oapg(
    ...
    def get_calculation_bases(
        ...
        return self._get_calculation_bases_oapg(
            path_params=args.path,
        )

class GetCalculationBases(BaseApi):
    ...
    async def aget_calculation_bases(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CalculationBasePydantic:
        raw_response = await self.raw.aget_calculation_bases(
            company_id=company_id,
            **kwargs,
        )
        if validate:
            return CalculationBasePydantic(**raw_response.body)
        return api_client.construct_model_instance(CalculationBasePydantic, raw_response.body)
    ...
    def get_calculation_bases(
        ...
        raw_response = self.raw.get_calculation_bases(
            company_id=company_id,
        )
        if validate:
            return CalculationBasePydantic(**raw_response.body)
