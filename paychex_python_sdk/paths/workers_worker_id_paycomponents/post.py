...
SchemaFor201ResponseBodyApplicationJson = RecurringResourceSchema
SchemaFor201ResponseBodyApplicationVndPaychexPayrollPaycomponentsV1json = RecurringResourceSchema
...
_response_for_201 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.payroll.paycomponents.v1+json': api_client.MediaType(
            schema=SchemaFor201ResponseBodyApplicationVndPaychexPayrollPaycomponentsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _add_pay_component_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aadd_pay_component_oapg(
        self,
...
class AddPayComponentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_pay_component(
        self,
        worker_id: str,
        worker_component_id: typing.Optional[str] = None,
        component_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._add_pay_component_mapped_args(
            worker_id=worker_id,
        ...
        return await self._aadd_pay_component_oapg(
            body=args.body,
    ...
    def add_pay_component(
        ...
        return self._add_pay_component_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddPayComponent(BaseApi):
    ...
    async def aadd_pay_component(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_pay_component(
            worker_id=worker_id,
            worker_component_id=worker_component_id,
            component_id=component_id,
            name=name,
    ...
    def add_pay_component(
        ...
        raw_response = self.raw.add_pay_component(
            worker_id=worker_id,
            worker_component_id=worker_component_id,
            component_id=component_id,
            name=name,
