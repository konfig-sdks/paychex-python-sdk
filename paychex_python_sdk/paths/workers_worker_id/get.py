...
SchemaFor200ResponseBodyApplicationVndPaychexWorkerCommunicationsV1json = WorkerResource1Schema
SchemaFor200ResponseBodyApplicationVndPaychexWorkerNonpiiV1json = WorkerResource1Schema
SchemaFor200ResponseBodyApplicationVndPaychexWorkerNonpiiCommunicationsV1json = WorkerResource1Schema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.worker_communications.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexWorkerCommunicationsV1json),
        'application/vnd.paychex.worker.nonpii.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexWorkerNonpiiV1json),
        'application/vnd.paychex.worker.nonpii_communications.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexWorkerNonpiiCommunicationsV1json),
    },
)
