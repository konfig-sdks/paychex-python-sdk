...
class BaseApi(api_client.Api):
    ...
    def _delete_in_progress_mapped_args(
        self,
        worker_id: str,
    ...
    async def _adelete_in_progress_oapg(
        self,
...
class DeleteInProgressRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_in_progress(
        self,
        worker_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_in_progress_mapped_args(
            worker_id=worker_id,
        )
        return await self._adelete_in_progress_oapg(
    ...
    def delete_in_progress(
        ...
        return self._delete_in_progress_oapg(
            path_params=args.path,
        )

class DeleteInProgress(BaseApi):
    ...
    async def adelete_in_progress(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_in_progress(
            worker_id=worker_id,
            **kwargs,
        )
    ...
    def delete_in_progress(
        ...
        raw_response = self.raw.delete_in_progress(
            worker_id=worker_id,
        )
