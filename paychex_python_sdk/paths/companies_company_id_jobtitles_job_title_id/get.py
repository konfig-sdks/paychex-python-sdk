...
WorkerJobTitleIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'companyId': typing.Union[CompanyIdSchema, str, ],
        'workerJobTitleId': typing.Union[WorkerJobTitleIdSchema, str, ],
    }
)
...
request_path_worker_job_title_id = api_client.PathParameter(
    name="workerJobTitleId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=WorkerJobTitleIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = JobTitleResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexCompanyJobtitleV1json = JobTitleResourceSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobTitleResource
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.jobtitle.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyJobtitleV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_job_title_mapped_args(
        self,
        company_id: str,
        worker_job_title_id: str,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        if company_id is not None:
            _path_params["companyId"] = company_id
        if worker_job_title_id is not None:
            _path_params["workerJobTitleId"] = worker_job_title_id
        args.path = _path_params
        return args

    async def _aget_job_title_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_path_worker_job_title_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/jobtitles/{jobTitleId}',
            headers=_headers,
        )
...
class GetJobTitleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_job_title(
        self,
        company_id: str,
        worker_job_title_id: str,
        **kwargs,
        ...
        args = self._get_job_title_mapped_args(
            company_id=company_id,
            worker_job_title_id=worker_job_title_id,
        )
        return await self._aget_job_title_oapg(
    ...
    def get_job_title(
        ...
        return self._get_job_title_oapg(
            path_params=args.path,
        )

class GetJobTitle(BaseApi):
    ...
    async def aget_job_title(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobTitleResourcePydantic:
        raw_response = await self.raw.aget_job_title(
            company_id=company_id,
            worker_job_title_id=worker_job_title_id,
            **kwargs,
        )
        if validate:
            return JobTitleResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobTitleResourcePydantic, raw_response.body)
    ...
    def get_job_title(
        ...
        raw_response = self.raw.get_job_title(
            company_id=company_id,
            worker_job_title_id=worker_job_title_id,
        )
        if validate:
