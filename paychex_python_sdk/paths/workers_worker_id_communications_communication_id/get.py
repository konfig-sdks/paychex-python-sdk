...
class BaseApi(api_client.Api):
    ...
    def _get_communication_item_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aget_communication_item_oapg(
        self,
    ...
    def _get_communication_item_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCommunicationItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_communication_item(
        self,
        worker_id: str,
        communication_id: str,
        **kwargs,
        ...
        args = self._get_communication_item_mapped_args(
            worker_id=worker_id,
            communication_id=communication_id,
        )
        return await self._aget_communication_item_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_communication_item(
        self,
        worker_id: str,
        communication_id: str,
    ) -> typing.Union[
        ...
        return self._get_communication_item_oapg(
            path_params=args.path,
        )

class GetCommunicationItem(BaseApi):
    ...
    async def aget_communication_item(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_communication_item(
            worker_id=worker_id,
            communication_id=communication_id,
            **kwargs,
        )
    ...
    def get_communication_item(
        ...
        raw_response = self.raw.get_communication_item(
            worker_id=worker_id,
            communication_id=communication_id,
        )
        if validate:
