...
SchemaFor200ResponseBodyApplicationVndPaychexWorkerCommunicationsV1json = CommunicationResource1Schema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.worker.communications.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexWorkerCommunicationsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _remove_communication_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aremove_communication_oapg(
        self,
    ...
    def _remove_communication_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveCommunicationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_communication(
        self,
        worker_id: str,
        communication_id: str,
        **kwargs,
        ...
        args = self._remove_communication_mapped_args(
            worker_id=worker_id,
            communication_id=communication_id,
        )
        return await self._aremove_communication_oapg(
    ...
    def remove_communication(
        ...
        return self._remove_communication_oapg(
            path_params=args.path,
        )

class RemoveCommunication(BaseApi):
    ...
    async def aremove_communication(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_communication(
            worker_id=worker_id,
            communication_id=communication_id,
            **kwargs,
        )
    ...
    def remove_communication(
        ...
        raw_response = self.raw.remove_communication(
            worker_id=worker_id,
            communication_id=communication_id,
        )
        if validate:
