...
SchemaFor200ResponseBodyApplicationJson = OrganizationResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexCompanyOrganizationsV1json = OrganizationResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.organizations.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyOrganizationsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_organizations_mapped_args(
        self,
        company_id: str,
    ...
    async def _aget_organizations_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/organizations',
            headers=_headers,
        )
...
class GetOrganizationsRaw(BaseApi):
    ...
    async def aget_organizations(
        ...
        **kwargs,
        ...
        args = self._get_organizations_mapped_args(
            company_id=company_id,
        )
        return await self._aget_organizations_oapg(
...
class GetOrganizations(BaseApi):
    ...
    async def aget_organizations(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrganizationResourcePydantic:
        raw_response = await self.raw.aget_organizations(
            company_id=company_id,
            **kwargs,
        )
        if validate:
            return OrganizationResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(OrganizationResourcePydantic, raw_response.body)
    ...
    def get_organizations(
        ...
        raw_response = self.raw.get_organizations(
            company_id=company_id,
        )
        if validate:
            return OrganizationResourcePydantic(**raw_response.body)
