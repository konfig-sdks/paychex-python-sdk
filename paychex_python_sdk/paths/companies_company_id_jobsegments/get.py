...
from paychex_python_sdk.model.job_segments_config_resource import JobSegmentsConfigResource as JobSegmentsConfigResourceSchema
from paychex_python_sdk.model.error_resource import ErrorResource as ErrorResourceSchema

from paychex_python_sdk.type.job_segments_config_resource import JobSegmentsConfigResource
...
from paychex_python_sdk.pydantic.job_segments_config_resource import JobSegmentsConfigResource as JobSegmentsConfigResourcePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobSegmentsConfigResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexCompanyJobsegmentsV1json = JobSegmentsConfigResourceSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobSegmentsConfigResource
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.jobsegments.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyJobsegmentsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_job_segment_structure_setup_mapped_args(
        self,
        company_id: str,
    ...
    async def _aget_job_segment_structure_setup_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/jobsegments',
            headers=_headers,
        )
    ...
    def _get_job_segment_structure_setup_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetJobSegmentStructureSetupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_job_segment_structure_setup(
        self,
        company_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_job_segment_structure_setup_mapped_args(
            company_id=company_id,
        )
        return await self._aget_job_segment_structure_setup_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_job_segment_structure_setup(
        self,
        company_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_job_segment_structure_setup_oapg(
            path_params=args.path,
        )

class GetJobSegmentStructureSetup(BaseApi):
    ...
    async def aget_job_segment_structure_setup(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobSegmentsConfigResourcePydantic:
        raw_response = await self.raw.aget_job_segment_structure_setup(
            company_id=company_id,
            **kwargs,
        )
        if validate:
            return JobSegmentsConfigResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobSegmentsConfigResourcePydantic, raw_response.body)
    ...
    def get_job_segment_structure_setup(
        ...
        raw_response = self.raw.get_job_segment_structure_setup(
            company_id=company_id,
        )
        if validate:
            return JobSegmentsConfigResourcePydantic(**raw_response.body)
