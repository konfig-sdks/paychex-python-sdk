...
from paychex_python_sdk.model.pay_period_resource import PayPeriodResource as PayPeriodResourceSchema
from paychex_python_sdk.model.error_resource import ErrorResource as ErrorResourceSchema

from paychex_python_sdk.type.pay_period_resource import PayPeriodResource
...
from paychex_python_sdk.pydantic.pay_period_resource import PayPeriodResource as PayPeriodResourcePydantic
...
request_path_payperiod_id = api_client.PathParameter(
    name="payperiodId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PayperiodIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = PayPeriodResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexPayrollPeriodV1json = PayPeriodResourceSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PayPeriodResource
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.payroll.period.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexPayrollPeriodV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_pay_period_mapped_args(
        self,
        company_id: str,
        payperiod_id: str,
        ...
        if payperiod_id is not None:
            _path_params["payperiodId"] = payperiod_id
        args.path = _path_params
        return args

    async def _aget_pay_period_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/payperiods/{payperiodId}',
            headers=_headers,
        )
...
class GetPayPeriodRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_pay_period(
        self,
        company_id: str,
        payperiod_id: str,
        **kwargs,
        ...
        args = self._get_pay_period_mapped_args(
            company_id=company_id,
            payperiod_id=payperiod_id,
        )
        return await self._aget_pay_period_oapg(
    ...
    def get_pay_period(
        ...
        return self._get_pay_period_oapg(
            path_params=args.path,
        )

class GetPayPeriod(BaseApi):
    ...
    async def aget_pay_period(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PayPeriodResourcePydantic:
        raw_response = await self.raw.aget_pay_period(
            company_id=company_id,
            payperiod_id=payperiod_id,
            **kwargs,
        )
        if validate:
            return PayPeriodResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(PayPeriodResourcePydantic, raw_response.body)
    ...
    def get_pay_period(
        ...
        raw_response = self.raw.get_pay_period(
            company_id=company_id,
            payperiod_id=payperiod_id,
        )
        if validate:
