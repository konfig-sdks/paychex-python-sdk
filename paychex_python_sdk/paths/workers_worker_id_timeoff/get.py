...
from paychex_python_sdk.model.time_off_resource import TimeOffResource as TimeOffResourceSchema
from paychex_python_sdk.model.error_resource import ErrorResource as ErrorResourceSchema

from paychex_python_sdk.type.time_off_resource import TimeOffResource
from paychex_python_sdk.type.error_resource import ErrorResource

from ...api_client import Dictionary
from paychex_python_sdk.pydantic.time_off_resource import TimeOffResource as TimeOffResourcePydantic
...
SchemaFor200ResponseBodyApplicationJson = TimeOffResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexWorkerTimeoffV1json = TimeOffResourceSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimeOffResource
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.worker.timeoff.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexWorkerTimeoffV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_time_off_balance_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aget_time_off_balance_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{workerId}/timeoff',
            headers=_headers,
        )
    ...
    def _get_time_off_balance_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetTimeOffBalanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_time_off_balance(
        self,
        worker_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_time_off_balance_mapped_args(
            worker_id=worker_id,
        )
        return await self._aget_time_off_balance_oapg(
    ...
    def get_time_off_balance(
        ...
        return self._get_time_off_balance_oapg(
            path_params=args.path,
        )

class GetTimeOffBalance(BaseApi):
    ...
    async def aget_time_off_balance(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimeOffResourcePydantic:
        raw_response = await self.raw.aget_time_off_balance(
            worker_id=worker_id,
            **kwargs,
        )
        if validate:
            return TimeOffResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(TimeOffResourcePydantic, raw_response.body)
    ...
    def get_time_off_balance(
        ...
        raw_response = self.raw.get_time_off_balance(
            worker_id=worker_id,
        )
        if validate:
            return TimeOffResourcePydantic(**raw_response.body)
