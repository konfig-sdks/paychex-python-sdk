...
SchemaForRequestBodyApplicationVndPaychexWorkerCustomfieldsV1json = WorkerCustomFieldsResourceSchema
...
request_body_worker_custom_fields_resource = api_client.RequestBody(
    content={
        ...
        'application/vnd.paychex.worker.customfields.v1+json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationVndPaychexWorkerCustomfieldsV1json),
    },
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = WorkerCustomFieldsResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexWorkerCustomfieldsV1json = WorkerCustomFieldsResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.worker.customfields.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexWorkerCustomfieldsV1json),
    },
)
    ...
    async def _acreate_custom_field_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{workerId}/customfields',
            body=body,
            headers=_headers,
        )
