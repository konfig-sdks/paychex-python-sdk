...
request_path_customfieldid = api_client.PathParameter(
    name="customfieldid",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationVndPaychexCompanyCustomfieldsV1json = CustomFieldsResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.customfields.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyCustomfieldsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _update_custom_field_mapped_args(
        ...
        if customfieldid is not None:
            _path_params["customfieldid"] = customfieldid
    ...
    async def _aupdate_custom_field_oapg(
        ...
        content_type: str = 'application/vnd.paychex.company.customfields.v1+json',
        stream: bool = False,
        **kwargs,
    ) -> typing.Union[
