...
from paychex_python_sdk.model.job_segments_resource import JobSegmentsResource as JobSegmentsResourceSchema
from paychex_python_sdk.model.job_resource import JobResource as JobResourceSchema
...
from paychex_python_sdk.type.job_resource import JobResource
...
from paychex_python_sdk.pydantic.job_resource import JobResource as JobResourcePydantic
from paychex_python_sdk.pydantic.job_segments_resource import JobSegmentsResource as JobSegmentsResourcePydantic
...
# body param
SchemaForRequestBodyApplicationVndPaychexCompanyJobsV1json = JobResourceSchema


request_body_job_resource = api_client.RequestBody(
    content={
        'application/vnd.paychex.company.jobs.v1+json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationVndPaychexCompanyJobsV1json),
    },
    required=True,
)
SchemaFor201ResponseBodyApplicationJson = JobResourceSchema
SchemaFor201ResponseBodyApplicationVndPaychexCompanyJobsV1json = JobResourceSchema
...
_response_for_201 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.jobs.v1+json': api_client.MediaType(
            schema=SchemaFor201ResponseBodyApplicationVndPaychexCompanyJobsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _add_job_mapped_args(
        self,
        company_id: str,
        job_id: typing.Optional[str] = None,
        job_correlation_id: typing.Optional[str] = None,
        ...
        job_number: typing.Optional[JobSegmentsResource] = None,
        ...
        if job_id is not None:
            _body["jobId"] = job_id
        if job_correlation_id is not None:
            _body["jobCorrelationId"] = job_correlation_id
        if job_name is not None:
            _body["jobName"] = job_name
    ...
    async def _aadd_job_oapg(
        ...
        content_type: str = 'application/vnd.paychex.company.jobs.v1+json',
        stream: bool = False,
        **kwargs,
    ) -> typing.Union[
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/jobs',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_job_resource.serialize(body, content_type)
...
class AddJobRaw(BaseApi):
    ...
    async def aadd_job(
        ...
        **kwargs,
        ...
        args = self._add_job_mapped_args(
            company_id=company_id,
            job_id=job_id,
            job_correlation_id=job_correlation_id,
            job_name=job_name,
        ...
        return await self._aadd_job_oapg(
            body=args.body,
    ...
    def add_job(
        ...
        return self._add_job_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddJob(BaseApi):
    ...
    async def aadd_job(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_job(
            company_id=company_id,
            job_id=job_id,
            job_correlation_id=job_correlation_id,
            job_name=job_name,
        ...
        if validate:
            return JobResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobResourcePydantic, raw_response.body)
