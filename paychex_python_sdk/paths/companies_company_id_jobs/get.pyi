...
class GetJobsRaw(BaseApi):
    ...
    async def aget_jobs(
        ...
        **kwargs,
        ...
        args = self._get_jobs_mapped_args(
            company_id=company_id,
            asof=asof,
        )
        return await self._aget_jobs_oapg(
...
class GetJobs(BaseApi):
    ...
    async def aget_jobs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_jobs(
            company_id=company_id,
            asof=asof,
            **kwargs,
        )
    ...
    def get_jobs(
        ...
        raw_response = self.raw.get_jobs(
            company_id=company_id,
            asof=asof,
        )
        if validate:
