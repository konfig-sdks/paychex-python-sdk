...
SchemaFor200ResponseBodyApplicationVndPaychexCompanyOrganizationV1json = OrganizationResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.organization.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyOrganizationV1json),
    },
)
    ...
    async def _aget_organization_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/organizations/{orgId}',
            headers=_headers,
        )
