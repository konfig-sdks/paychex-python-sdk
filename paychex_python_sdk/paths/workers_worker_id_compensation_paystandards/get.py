...
from paychex_python_sdk.model.pay_standard_resource import PayStandardResource as PayStandardResourceSchema
...
from paychex_python_sdk.pydantic.pay_standard_resource import PayStandardResource as PayStandardResourcePydantic
...
SchemaFor200ResponseBodyApplicationJson = PayStandardResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexPayrollCompensationPaystandardsV1json = PayStandardResourceSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PayStandardResource
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.payroll.compensation.paystandards.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexPayrollCompensationPaystandardsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_pay_standards_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aget_pay_standards_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{workerId}/compensation/paystandards',
            headers=_headers,
        )
...
class GetPayStandardsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_pay_standards(
        self,
        worker_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_pay_standards_mapped_args(
            worker_id=worker_id,
        )
        return await self._aget_pay_standards_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_pay_standards(
        self,
        worker_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_pay_standards_oapg(
            path_params=args.path,
        )

class GetPayStandards(BaseApi):
    ...
    async def aget_pay_standards(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PayStandardResourcePydantic:
        raw_response = await self.raw.aget_pay_standards(
            worker_id=worker_id,
            **kwargs,
        )
        if validate:
            return PayStandardResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(PayStandardResourcePydantic, raw_response.body)
    ...
    def get_pay_standards(
        ...
        raw_response = self.raw.get_pay_standards(
            worker_id=worker_id,
        )
        if validate:
            return PayStandardResourcePydantic(**raw_response.body)
