...
SchemaFor200ResponseBodyApplicationVndPaychexCompanyLaborassignmentsV1json = LaborAssignmentResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.laborassignments.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyLaborassignmentsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _list_labor_assignments_mapped_args(
        self,
        company_id: str,
    ...
    async def _alist_labor_assignments_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/laborassignments',
            headers=_headers,
        )
    ...
    def _list_labor_assignments_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListLaborAssignmentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_labor_assignments(
        self,
        company_id: str,
        asof: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_labor_assignments_mapped_args(
            company_id=company_id,
            asof=asof,
        )
        return await self._alist_labor_assignments_oapg(
    ...
    def list_labor_assignments(
        ...
        return self._list_labor_assignments_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListLaborAssignments(BaseApi):
    ...
    async def alist_labor_assignments(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_labor_assignments(
            company_id=company_id,
            asof=asof,
            **kwargs,
        )
    ...
    def list_labor_assignments(
        ...
        raw_response = self.raw.list_labor_assignments(
            company_id=company_id,
            asof=asof,
        )
        if validate:
