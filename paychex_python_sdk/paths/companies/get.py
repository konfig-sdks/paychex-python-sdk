...
from paychex_python_sdk.model.company_resource import CompanyResource as CompanyResourceSchema
from paychex_python_sdk.model.error_resource import ErrorResource as ErrorResourceSchema

from paychex_python_sdk.type.company_resource import CompanyResource
...
from paychex_python_sdk.pydantic.company_resource import CompanyResource as CompanyResourcePydantic

from . import path

# Query params
DisplayidSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'displayid': typing.Union[DisplayidSchema, str, ],
    },
    total=False
)
...
request_query_displayid = api_client.QueryParameter(
    name="displayid",
    style=api_client.ParameterStyle.FORM,
    schema=DisplayidSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = CompanyResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexCompaniesV1json = CompanyResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.companies.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompaniesV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        if displayid is not None:
            _query_params["displayid"] = displayid
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompanyResourcePydantic:
        raw_response = await self.raw.alist(
            displayid=displayid,
            **kwargs,
        )
        if validate:
            return CompanyResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(CompanyResourcePydantic, raw_response.body)
