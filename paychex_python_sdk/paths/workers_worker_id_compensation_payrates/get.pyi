...
SchemaFor200ResponseBodyApplicationVndPaychexPayrollCompensationPayratesV1json = PayRateResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.payroll.compensation.payrates.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexPayrollCompensationPayratesV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_pay_rates_by_worker_id_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aget_pay_rates_by_worker_id_oapg(
        self,
    ...
    def _get_pay_rates_by_worker_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetPayRatesByWorkerIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_pay_rates_by_worker_id(
        self,
        worker_id: str,
        asof: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_pay_rates_by_worker_id_mapped_args(
            worker_id=worker_id,
            asof=asof,
        )
        return await self._aget_pay_rates_by_worker_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_pay_rates_by_worker_id(
        self,
        worker_id: str,
        asof: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_pay_rates_by_worker_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPayRatesByWorkerId(BaseApi):
    ...
    async def aget_pay_rates_by_worker_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_pay_rates_by_worker_id(
            worker_id=worker_id,
            asof=asof,
            **kwargs,
        )
    ...
    def get_pay_rates_by_worker_id(
        ...
        raw_response = self.raw.get_pay_rates_by_worker_id(
            worker_id=worker_id,
            asof=asof,
        )
        if validate:
