...
class BaseApi(api_client.Api):
    ...
    def _remove_federal_tax_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aremove_federal_tax_oapg(
        self,
...
class RemoveFederalTaxRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_federal_tax(
        self,
        worker_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_federal_tax_mapped_args(
            worker_id=worker_id,
        )
        return await self._aremove_federal_tax_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_federal_tax(
        self,
        worker_id: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._remove_federal_tax_oapg(
            path_params=args.path,
        )

class RemoveFederalTax(BaseApi):
    ...
    async def aremove_federal_tax(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_federal_tax(
            worker_id=worker_id,
            **kwargs,
        )
    ...
    def remove_federal_tax(
        ...
        raw_response = self.raw.remove_federal_tax(
            worker_id=worker_id,
        )
