...
SchemaFor200ResponseBodyApplicationVndPaychexWorkerFederaltax2020V1json = WorkerFederalTaxResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.paychex.worker.federaltax2020.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexWorkerFederaltax2020V1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _update_federal_tax_setup_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aupdate_federal_tax_setup_oapg(
        self,
    ...
    def _update_federal_tax_setup_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateFederalTaxSetupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_federal_tax_setup(
        self,
        worker_id: str,
        tax_id: typing.Optional[str] = None,
        filing_status: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_federal_tax_setup_mapped_args(
            worker_id=worker_id,
            tax_id=tax_id,
        ...
        return await self._aupdate_federal_tax_setup_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_federal_tax_setup(
        self,
        worker_id: str,
        tax_id: typing.Optional[str] = None,
        filing_status: typing.Optional[str] = None,
        ...
        return self._update_federal_tax_setup_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFederalTaxSetup(BaseApi):
    ...
    async def aupdate_federal_tax_setup(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_federal_tax_setup(
            worker_id=worker_id,
            tax_id=tax_id,
            filing_status=filing_status,
            multiple_jobs=multiple_jobs,
    ...
    def update_federal_tax_setup(
        ...
        raw_response = self.raw.update_federal_tax_setup(
            worker_id=worker_id,
            tax_id=tax_id,
            filing_status=filing_status,
            multiple_jobs=multiple_jobs,
