...
class BaseApi(api_client.Api):
    ...
    def _get_federal_tax_setup_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aget_federal_tax_setup_oapg(
        self,
    ...
    def _get_federal_tax_setup_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetFederalTaxSetupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_federal_tax_setup(
        self,
        worker_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_federal_tax_setup_mapped_args(
            worker_id=worker_id,
        )
        return await self._aget_federal_tax_setup_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_federal_tax_setup(
        self,
        worker_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_federal_tax_setup_oapg(
            path_params=args.path,
        )

class GetFederalTaxSetup(BaseApi):
    ...
    async def aget_federal_tax_setup(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_federal_tax_setup(
            worker_id=worker_id,
            **kwargs,
        )
        if validate:
    ...
    def get_federal_tax_setup(
        ...
        raw_response = self.raw.get_federal_tax_setup(
            worker_id=worker_id,
        )
        if validate:
            return WorkerFederalTaxResourcePydantic(**raw_response.body)
