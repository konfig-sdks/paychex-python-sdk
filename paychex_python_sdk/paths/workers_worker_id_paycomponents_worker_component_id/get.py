...
class BaseApi(api_client.Api):
    ...
    def _get_pay_component_mapped_args(
        self,
        worker_id: str,
    ...
    async def _aget_pay_component_oapg(
        self,
...
class GetPayComponentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_pay_component(
        self,
        worker_id: str,
        worker_component_id: str,
        asof: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_pay_component_mapped_args(
            worker_id=worker_id,
            worker_component_id=worker_component_id,
            asof=asof,
        )
        return await self._aget_pay_component_oapg(
    ...
    def get_pay_component(
        ...
        return self._get_pay_component_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPayComponent(BaseApi):
    ...
    async def aget_pay_component(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_pay_component(
            worker_id=worker_id,
            worker_component_id=worker_component_id,
            asof=asof,
            **kwargs,
    ...
    def get_pay_component(
        ...
        raw_response = self.raw.get_pay_component(
            worker_id=worker_id,
            worker_component_id=worker_component_id,
            asof=asof,
        )
