...
class BaseApi(api_client.Api):
    ...
    def _remove_pay_rate_mapped_args(
        self,
        worker_id: str,
        rate_id: str,
    ...
    async def _aremove_pay_rate_oapg(
        self,
...
class RemovePayRateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_pay_rate(
        self,
        worker_id: str,
        rate_id: str,
        **kwargs,
        ...
        args = self._remove_pay_rate_mapped_args(
            worker_id=worker_id,
            rate_id=rate_id,
        )
        return await self._aremove_pay_rate_oapg(
    ...
    def remove_pay_rate(
        ...
        return self._remove_pay_rate_oapg(
            path_params=args.path,
        )

class RemovePayRate(BaseApi):
    ...
    async def aremove_pay_rate(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_pay_rate(
            worker_id=worker_id,
            rate_id=rate_id,
            **kwargs,
        )
    ...
    def remove_pay_rate(
        ...
        raw_response = self.raw.remove_pay_rate(
            worker_id=worker_id,
            rate_id=rate_id,
        )
