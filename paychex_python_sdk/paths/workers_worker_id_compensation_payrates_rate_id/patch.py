...
from paychex_python_sdk.model.pay_rate_resource import PayRateResource as PayRateResourceSchema
...
from paychex_python_sdk.pydantic.pay_rate_resource import PayRateResource as PayRateResourcePydantic
...
RateIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'workerId': typing.Union[WorkerIdSchema, str, ],
        'rateId': typing.Union[RateIdSchema, str, ],
    }
)
...
request_path_rate_id = api_client.PathParameter(
    name="rateId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RateIdSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = PayRateResourceSchema
SchemaForRequestBodyApplicationVndPaychexPayrollCompensationPayrateV1json = PayRateResourceSchema


request_body_pay_rate_resource = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
        'application/vnd.paychex.payroll.compensation.payrate.v1+json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationVndPaychexPayrollCompensationPayrateV1json),
    },
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = PayRateResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexPayrollCompensationPayrateV1json = PayRateResourceSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PayRateResource
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.payroll.compensation.payrate.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexPayrollCompensationPayrateV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _update_compensation_rate_mapped_args(
        self,
        worker_id: str,
        rate_id: str,
        ...
        rate_number: typing.Optional[str] = None,
        rate_type: typing.Optional[str] = None,
        amount: typing.Optional[str] = None,
        standard_hours: typing.Optional[str] = None,
        standard_overtime: typing.Optional[str] = None,
        ...
        if rate_id is not None:
            _body["rateId"] = rate_id
        if start_date is not None:
            _body["startDate"] = start_date
        if rate_number is not None:
            _body["rateNumber"] = rate_number
        if rate_type is not None:
            _body["rateType"] = rate_type
        if amount is not None:
            _body["amount"] = amount
        if standard_hours is not None:
            _body["standardHours"] = standard_hours
        if standard_overtime is not None:
            _body["standardOvertime"] = standard_overtime
    ...
    async def _aupdate_compensation_rate_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{workerId}/compensation/payrates/{rateId}',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_pay_rate_resource.serialize(body, content_type)
    ...
    def _update_compensation_rate_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateCompensationRateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_compensation_rate(
        self,
        worker_id: str,
        rate_id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_compensation_rate_mapped_args(
            worker_id=worker_id,
            rate_id=rate_id,
        ...
        return await self._aupdate_compensation_rate_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_compensation_rate(
        self,
        worker_id: str,
        rate_id: str,
        description: typing.Optional[str] = None,
        ...
        return self._update_compensation_rate_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateCompensationRate(BaseApi):
    ...
    async def aupdate_compensation_rate(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PayRateResourcePydantic:
        raw_response = await self.raw.aupdate_compensation_rate(
            worker_id=worker_id,
            rate_id=rate_id,
            description=description,
            rate_id=rate_id,
        ...
        if validate:
            return PayRateResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(PayRateResourcePydantic, raw_response.body)
    ...
    def update_compensation_rate(
        ...
        raw_response = self.raw.update_compensation_rate(
            worker_id=worker_id,
            rate_id=rate_id,
            description=description,
            rate_id=rate_id,
