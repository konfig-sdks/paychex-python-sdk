...
class GetPayRateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_pay_rate(
        self,
        worker_id: str,
        rate_id: str,
        asof: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_pay_rate_mapped_args(
            worker_id=worker_id,
            rate_id=rate_id,
            asof=asof,
        )
        return await self._aget_pay_rate_oapg(
    ...
    def get_pay_rate(
        ...
        return self._get_pay_rate_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPayRate(BaseApi):
    ...
    async def aget_pay_rate(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_pay_rate(
            worker_id=worker_id,
            rate_id=rate_id,
            asof=asof,
            **kwargs,
    ...
    def get_pay_rate(
        ...
        raw_response = self.raw.get_pay_rate(
            worker_id=worker_id,
            rate_id=rate_id,
            asof=asof,
        )
