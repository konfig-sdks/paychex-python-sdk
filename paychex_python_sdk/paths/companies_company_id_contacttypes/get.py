...
from paychex_python_sdk.model.contact_type_resource import ContactTypeResource as ContactTypeResourceSchema
from paychex_python_sdk.model.error_resource import ErrorResource as ErrorResourceSchema

from paychex_python_sdk.type.contact_type_resource import ContactTypeResource
...
from paychex_python_sdk.pydantic.contact_type_resource import ContactTypeResource as ContactTypeResourcePydantic
...
SchemaFor200ResponseBodyApplicationJson = ContactTypeResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexCompanyContacttypesV1json = ContactTypeResourceSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContactTypeResource
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.contacttypes.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyContacttypesV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_contact_types_mapped_args(
        self,
        company_id: str,
    ...
    async def _aget_contact_types_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/contacttypes',
            headers=_headers,
        )
...
class GetContactTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_contact_types(
        self,
        company_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_contact_types_mapped_args(
            company_id=company_id,
        )
        return await self._aget_contact_types_oapg(
    ...
    def get_contact_types(
        ...
        return self._get_contact_types_oapg(
            path_params=args.path,
        )

class GetContactTypes(BaseApi):
    ...
    async def aget_contact_types(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContactTypeResourcePydantic:
        raw_response = await self.raw.aget_contact_types(
            company_id=company_id,
            **kwargs,
        )
        if validate:
            return ContactTypeResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(ContactTypeResourcePydantic, raw_response.body)
    ...
    def get_contact_types(
        ...
        raw_response = self.raw.get_contact_types(
            company_id=company_id,
        )
        if validate:
            return ContactTypeResourcePydantic(**raw_response.body)
