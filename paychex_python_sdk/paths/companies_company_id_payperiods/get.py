...
SchemaFor200ResponseBodyApplicationVndPaychexPayrollPeriodsV1json = PayPeriodResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.payroll.periods.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexPayrollPeriodsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_company_pay_periods_mapped_args(
        self,
        company_id: str,
    ...
    async def _aget_company_pay_periods_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/payperiods',
            headers=_headers,
        )
    ...
    def _get_company_pay_periods_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCompanyPayPeriodsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_company_pay_periods(
        self,
        company_id: str,
        status: typing.Optional[typing.List[str]] = None,
        _from: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_company_pay_periods_mapped_args(
            company_id=company_id,
            status=status,
            _from=_from,
            to=to,
        )
        return await self._aget_company_pay_periods_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_company_pay_periods(
        self,
        company_id: str,
        status: typing.Optional[typing.List[str]] = None,
        _from: typing.Optional[str] = None,
        ...
        return self._get_company_pay_periods_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCompanyPayPeriods(BaseApi):
    ...
    async def aget_company_pay_periods(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_company_pay_periods(
            company_id=company_id,
            status=status,
            _from=_from,
            to=to,
    ...
    def get_company_pay_periods(
        ...
        raw_response = self.raw.get_company_pay_periods(
            company_id=company_id,
            status=status,
            _from=_from,
            to=to,
