...
from paychex_python_sdk.model.location_resource import LocationResource as LocationResourceSchema
from paychex_python_sdk.model.error_resource import ErrorResource as ErrorResourceSchema

from paychex_python_sdk.type.location_resource import LocationResource
from paychex_python_sdk.type.error_resource import ErrorResource

from ...api_client import Dictionary
from paychex_python_sdk.pydantic.location_resource import LocationResource as LocationResourcePydantic
...
SchemaFor200ResponseBodyApplicationJson = LocationResourceSchema
SchemaFor200ResponseBodyApplicationVndPaychexCompanyLocationsV1json = LocationResourceSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/vnd.paychex.company.locations.v1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndPaychexCompanyLocationsV1json),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_locations_mapped_args(
        self,
        company_id: str,
    ...
    async def _aget_locations_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/companies/{companyId}/locations',
            headers=_headers,
        )
...
class GetLocationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_locations(
        self,
        company_id: str,
        asof: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_locations_mapped_args(
            company_id=company_id,
            asof=asof,
        )
        return await self._aget_locations_oapg(
...
class GetLocations(BaseApi):
    ...
    async def aget_locations(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LocationResourcePydantic:
        raw_response = await self.raw.aget_locations(
            company_id=company_id,
            asof=asof,
            **kwargs,
        )
        if validate:
            return LocationResourcePydantic(**raw_response.body)
        return api_client.construct_model_instance(LocationResourcePydantic, raw_response.body)
    ...
    def get_locations(
        ...
        raw_response = self.raw.get_locations(
            company_id=company_id,
            asof=asof,
        )
        if validate:
